...
const styles = {
  ...
  sectionTitle: { fontSize: '1.5rem', color: '#065f46', marginBottom: '1.5rem', textAlign: 'center' },
  infoItem: { display: 'flex', gap: '1rem', marginBottom: '1.5rem', alignItems: 'flex-start' },
  infoIcon: { fontSize: '1.75rem', flexShrink: 0 },
  infoLabel: { fontSize: '0.95rem', color: '#059669', marginBottom: '0.3rem' },
  infoText: { fontSize: '0.92rem', color: '#475569', lineHeight: 1.6, margin: 0 },
  infoLink: { fontSize: '0.92rem', color: '#059669', textDecoration: 'none', lineHeight: 1.6 },
  ...
  submitBtn: { background: '#059669', color: '#fff', border: 'none', padding: '0.85rem 1.5rem', borderRadius: '8px', fontSize: '1rem', fontWeight: 'bold', cursor: 'pointer', width: '100%' },
