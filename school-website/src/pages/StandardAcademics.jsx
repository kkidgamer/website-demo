  ...
  const levels = [
    {
      ...
      features: ['Language & phonics', 'Number sense & basic math', 'Storytelling & reading', 'Art, music & movement', 'Outdoor play & field trips']
    },
    {
      ...
      features: ['English language arts', 'Mathematics', 'Science & discovery', 'Social studies & geography', 'Computer literacy', 'Physical education & sports']
    },
    {
      ...
      features: ['Advanced mathematics', 'Integrated sciences (biology, chemistry, physics)', 'Humanities & history', 'Second language options', 'Creative arts & design', 'Electives & clubs']
    },
    {
      ...
      features: ['Sciences (biology, chemistry, physics)', 'Commerce & business studies', 'Humanities & literature', 'Advanced mathematics', 'ICT & digital skills', 'Career guidance & university prep']
    }
  ]

  const programs = [
    { name: 'STEM Program', desc: 'Robotics, coding, science clubs, and hands-on lab work to inspire future innovators.' },
    { name: 'Languages', desc: 'English as primary medium. Optional second languages include French and Swahili.' },
    { name: 'Arts & Culture', desc: 'Music, drama, visual arts, and cultural events that celebrate creativity and diversity.' },
    { name: 'Sports & PE', desc: 'Regular physical education plus competitive teams in football, basketball, and athletics.' },
    { name: 'Special Support', desc: 'Learning support and counseling for students who need extra help or enrichment.' }
  ]
...
const styles = {
  ...
  levelName: { fontSize: '1.1rem', color: '#2563eb', marginBottom: '0.75rem', fontWeight: 600 },
  ...
  programGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '1.5rem' },
  programCard: { background: '#eef4ff', padding: '1.25rem', borderRadius: '10px', borderLeft: '4px solid #2563eb' },
  programName: { fontSize: '1.05rem', color: '#1e3a5f', marginBottom: '0.5rem' },
...
export default StandardAcademics
